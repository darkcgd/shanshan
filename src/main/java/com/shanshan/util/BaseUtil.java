...
import com.shanshan.bean.WxToken;
...
public class BaseUtil {
    ...
    // 凭证获取（GET）
    public final static String token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid="+Config.AppID+"&secret="+Config.AppSecret+"";
