...
public class ArticleBean {
    ...
    private Integer relateActivityId;
    ...
    public Integer getRelateActivityId() {
        return relateActivityId;
    }

    public void setRelateActivityId(Integer relateActivityId) {
        this.relateActivityId = relateActivityId;
    }
