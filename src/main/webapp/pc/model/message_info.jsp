...
#addinfo a{ font-size:14px; font-weight:bold; background:url(/shanshan/pc/images/main/replayblack.jpg) no-repeat 0 0px; padding:0px 0 0px 20px; line-height:45px;}
#addinfo a:hover{ background:url(/shanshan/pc/images/main/replayblue.jpg) no-repeat 0 0px;}
</style>
</head>
<body>
<!--main_top-->
