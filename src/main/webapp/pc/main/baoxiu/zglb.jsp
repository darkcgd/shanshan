...
<form name="listform" method="post" action="" onsubmit="return confirm('确认要执行此操作？');">
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
    ...
    <tr> 
      ...
      <td width="6%" height="25"><div align="center">机床品牌</div></td>
      <td width="36%" height="25"><div align="center">故障描述</div></td>
    ...
    <tr bgcolor="#FFFFFF" onmouseout="this.style.backgroundColor='#ffffff'" onmouseover="this.style.backgroundColor='#C3EFFF'"> 
      ...
      <td height="25"> <div align="center"> s/n </div></td>                        
      <td height="25"> <div align="center">某零件损坏</div></td>
