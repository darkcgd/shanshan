...
<html>
	<head>
		...
		<script src="pc/js/webpackDevServer.config.js" type="text/javascript" charset="utf-8"></script>
		<script src="pc/js/strophe-1.2.8.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="pc/js/websdk.shim.js" type="text/javascript" charset="utf-8"></script>
	</head>
